...
/**
 * Created by flori on 02-01-18.
 */

public class WriteTaskPillsS7 {

    private AtomicBoolean isRunning = new AtomicBoolean(false);
    private Thread writeThread;
    private WriteTaskPillsS7.AutomateS7 plcS7;
    ...
    public WriteTaskPillsS7(int datablocNumber) {

        comS7 = new S7Client();
        plcS7 = new WriteTaskPillsS7.AutomateS7();
        ...
        public void run() {
            try {
                ...
                while (isRunning.get() && (res.equals(0))) {
                    ...
                    //comS7.WriteArea(S7.S7AreaDB, datablocNumber, 18, 2, dbb18);
    ...
    public void setWriteByte(int pos, int value) {
        ...
        S7.SetWordAt(motCommande, pos, S7.ByteToBCD(value));
    }
}
